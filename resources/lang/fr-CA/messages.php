...
return array (
  ...
  ' in ' => ' à ',
  '%1$s %2$s has a %3$s link to %4$s.' => '%1$s %2$s a un %3$s lien vers %4$s.',
  ...
  '%H:%i:%s' => '%H:%i:%s',
  '%j %F %Y' => '%j %F %Y',
  '%s BCE' => '%s avant cette ère',
  '%s KB' => '%s Ko',
  '%s and her ancestors' => '%s et ses ancêtres',
  '%s and his ancestors' => '%s et ses ancêtres',
  '%s and the individuals that reference it.' => '%s et les individus qui lui sont liés.',
  '%s and their children' => '%s et leurs enfants',
  '%s and their descendants' => '%s et leurs descendants',
  ...
  '%s family tree' . "\0" . '%s family trees' => '%s arbre généalogique' . "\0" . '%s arbres généalogiques',
  ...
  '%s repository has been updated.' . "\0" . '%s repositories have been updated.' => '%s dépôt d’archives a été mis à jour.' . "\0" . '%s dépôts d’archives ont été mis à jour.',
  '%s sent you the following message.' => '%s vous a envoyé le message ci-dessous.',
  ...
  '%s × cousin' => '%s<sup>e</sup> arrière-petit(e)-cousin(e)',
  'FEMALE%s × cousin' => 'cousine au (%s+1)<sup>e</sup> degré',
  'MALE%s × cousin' => 'cousin au (%s+1)<sup>e</sup> degré',
  '%s&nbsp;BCE' => '%s&nbsp;Avant cette ère',
  '%s&nbsp;CE' => '%s&nbsp;De cette ère',
  '%s+' => '%s+',
  '%s, her ancestors and their families' => '%s, ses ancêtres et leurs familles',
  '%s, her parents and siblings' => '%s, ses parents et ses proches',
  ...
  '%s, his ancestors and their families' => '%s, ses ancêtres et leurs familles',
  '%s, his parents and siblings' => '%s, ses parents et leurs proches',
  '%s, his spouses and children' => '%s, ses épouses et ses enfants',
  '%s, his spouses and descendants' => '%s, ses conjoints et ses descendants',
  '&lt;select&gt;' => '&lt;sélectionner&gt;',
  ...
  'A chart of an individual’s ancestors and descendants, as a family book.' => 'Un diagramme des ancêtres et des descendants d’un individu, comme un livret de famille.',
  'A chart of an individual’s ancestors, as a compact tree.' => 'Un diagramme des ancêtres d’un individu, comme un arbre compact.',
  'A chart of an individual’s ancestors, formatted as a tree.' => 'Un diagramme des ancêtres d’un individu, formaté comme un arbre.',
  ...
  'A child may have more than one set of parents. The relationship between the child and the parents can be biological, legal, or based on local culture and tradition. If no pedigree is specified, then a biological relationship will be assumed.' => 'Un enfant peut avoir plus d’un couple de parents. La relation entre l’enfant et ses parents peut être biologique, légale ou basée sur la culture locale et la tradition. Par défaut, elle sera biologique si la relation n’est pas spécifiée.',
  'A common error is to have multiple links to the same record, for example listing the same child more than once in a family record.' => 'Une erreur commune est d’avoir plusieurs liens vers le même enregistrement, par exemple, lister le même enfant plus d’une fois dans un livret de famille.',
  'A fan chart of an individual’s ancestors.' => 'Un diagramme en forme de roue des ancêtres d’un individu.',
  'A file on the server' => 'Un fichier sur le serveur',
  'A file on your computer' => 'Un fichier dans votre ordinateur',
  ...
  'A link to the webtrees home page.' => 'Lien vers la page Portail de webtrees.',
  'A list of branches of a family.' => 'Liste des branches d’une famille.',
  'A list of changes that need to be reviewed by a moderator, and email notifications.' => 'Une liste des modifications en attente d’approbation, et notifications par courriel.',
  'A list of families.' => 'Liste des familles.',
  'A list of frequently asked questions and answers.' => 'Liste de questions fréquentes et leurs réponses.',
  'A list of individuals.' => 'Liste des individus.',
  'A list of media objects.' => 'Liste des objets médias.',
  'A list of records that have been updated recently.' => 'Liste des documents mis à jour récemment.',
  ...
  'A list of the Hebrew death anniversaries that will occur in the near future.' => 'Une liste des prochains anniversaires de décès Yahrzeiten.',
  ...
  'A list of the most popular given names.' => 'Une liste des prénoms les plus populaires.',
  'A list of the most popular surnames.' => 'Une liste des noms de famille les plus populaires.',
  'A list of the pages that have been viewed the most number of times.' => 'Liste des pages visitées le plus grand nombre de fois.',
  ...
  'A report of an individual’s ancestors, formatted as a tree.' => 'Rapport des ancêtres d’un individu, affiché comme un arbre.',
  ...
  'A report of family members and their details.' => 'Données généalogiques des membres d’une famille.',
  ...
  'A report of individuals who were born in a given time or place.' => 'Rapport des individus nés à une époque ou en un lieu donné.',
  'A report of individuals who were buried in a given place.' => 'Rapport des individus qui ont été enterrés en un lieu donné.',
  'A report of individuals who were married in a given time or place.' => 'Rapport des individus qui se sont mariés à une époque ou en un lieu.',
  ...
  'A report of the individuals that are closely related to an individual.' => 'Rapport des individus étroitement liées à un individu.',
  ...
  'A report of vital records for a given date or place.' => 'Rapport des enregistrements (naissance, mariage, décès) pour une date ou un lieu donnés.',
  'A role is a set of access rights, which give permission to view data, change preferences, etc. Access rights are assigned to roles, and roles are granted to users. Each family tree can assign different access to each role, and users can have a different role in each family tree.' => 'Un rôle est un ensemble de droits d’accès, qui donnent l’autorisation de voir des données, de modifier des paramètres, etc. Les droits d’accès sont affectés à des rôles, et les rôles sont accordés aux utilisateurs. Chaque arbre généalogique peut attribuer un accès différent à chaque rôle, et les utilisateurs peuvent avoir un rôle différent dans chaque arbre généalogique.',
  'A sidebar showing an individual’s close families and relatives.' => 'Barre latérale montrant les proches et la parenté d’un individu.',
  ...
  'A user will not be able to sign in until both “email verified” and “approved by administrator” are selected.' => 'Un utilisateur ne sera pas capable de se connecter jusqu’à ce que les options «&nbsp;courriel vérifié&nbsp;» et «&nbsp;approuvé par l’administrateur&nbsp;» soient effectuées.',
  'paper sizeA3' => 'A3',
  'paper sizeA4' => 'A4',
  ...
  'Accept' => 'Accepter',
  'Accept all changes' => 'Approuver toutes les modifications',
  'Access level' => 'Droits pour Modifier',
  ...
  'Add a husband' => 'Ajouter un nouveau conjoint',
  'Add a husband using an existing individual' => 'Ajouter un conjoint en utilisant une personne existante',
  ...
  'Add a wife' => 'Ajouter une nouvelle conjointe',
  'Add a wife using an existing individual' => 'Ajouter une conjointe en utilisant une personne existante',
  'Add an FAQ' => 'Ajouter une FAQ',
  ...
  'Add new, and update existing records' => 'Ajouter un nouvel enregistrement et mettre à jour ceux déjà existants',
  'Add spaces where long lines were wrapped' => 'Ajouter des espaces où des retours à la ligne ont été effectués',
  ...
  'Add unique identifiers' => 'Ajouter des identifiants uniques',
  'Add unlinked records' => 'Ajouter un élément isolé',
  'Add your own text and graphics.' => 'Ajouter votre texte et vos graphiques personnalisés.',
  'Add/edit a journal/news entry' => 'Ajouter/Editer le journal/Nouvelle entrée',
  'Address' => 'Adresse',
  ...
  'Advanced fact preferences' => 'Paramètres avancés des faits',
  ...
  'Africa' => 'Afrique',
  'After creating the family tree, you will be able to import data from a GEDCOM file.' => 'Après avoir créé l’arbre généalogique, vous pourrez importer les données d’un fichier GEDCOM.',
  'Age' => 'Âge',
  'Age at birth of child' => 'Âge à la naissance de l’enfant',
  'Age at which to assume an individual is dead' => 'Âge maxi d’une personne',
  ...
  'Alive' => 'Vivant',
  'All' => 'Tous',
  'All facts and events' => 'Tous les faits et événements',
  ...
  'Allow visitors to request a new user account' => 'Permettre aux visiteurs de demander un nouveau compte',
  'Also known as' => 'Nom dit ou alias',
  'American Samoa' => 'Samoas américaines',
  'An FAQ can be displayed on just one of the family trees, or on all the family trees.' => 'Un élément FAQ peut être affiché sur un seul arbre ou sur tous les arbres généalogiques.',
  ...
  'An alternative way to enter census transcripts and link them to individuals.' => 'Un autre façon d’entrer les données des recensements et de les relier aux individus.',
  ...
  'Anyone with a user account can access this website.' => 'Toute personne ayant un compte peut accéder à ce site.',
  ...
  'Are you sure you want to delete this fact?' => 'Confirmez-vous la suppression de cet élément&nbsp;?',
  'Are you sure you want to delete this message? It cannot be retrieved later.' => 'Confirmez-vous la suppression de ce message&nbsp;? Toute suppression est définitive.',
  ...
  'Are you sure you want to remove this item from your list of favorites?' => 'Confirmez-vous la suppression de ce signet&nbsp;?',
  'Argentina' => 'Argentine',
  ...
  'Automatically accept changes made by this user' => 'Approuver automatiquement les modifications faites par cet utilisateur',
  ...
  'Birth date range end' => 'Date de naissance maxi',
  'Birth date range start' => 'Date de naissance mini',
  ...
  'Birthplace contains' => 'Lieu de naissance contient',
  'Births' => 'Naissances',
  ...
  'Burial of a husband' => 'Enterrement d’un mari',
  ...
  'Change the “Home page” blocks' => 'Changer les blocs de la page «&nbsp;Accueil&nbsp;»',
  'Change the “My page” blocks' => 'Changer les blocs de la page «&nbsp;Ma page&nbsp;»',
  'Changed on %1$s' => 'Changements de %1$s',
  ...
  'Charts' => 'Diagrammes',
  'Check for errors' => 'Rechercher les erreurs',
  'Check for pending changes…' => 'Vérifier les modifications en attente d’approbation…',
  ...
  'Children take one surname from the father and one surname from the mother.' => 'Les enfants portent un nom du père et un nom de la mère.',
  'Children take one surname from the mother and one surname from the father.' => 'Les enfants portent un nom de la mère et un nom du père.',
  'Children take their father’s surname.' => 'Les enfants portent le nom de famille de leur père.',
  'Children take their mother’s surname.' => 'Les enfants portent le nom de famille de leur mère.',
  'Chile' => 'Chili',
  'China' => 'Chine',
  ...
  'Christening' => 'Baptême religieux enfant',
  ...
  'Civil registrar' => 'Officier de l’Etat-Civil',
  'FEMALECivil registrar' => 'Officier de l’Etat-Civil',
  'MALECivil registrar' => 'Officier de l’Etat-Civil',
  ...
  'Compress the GEDCOM file' => 'Compresser le fichier GEDCOM',
  ...
  'Convert from UTF-8 to ISO-8859-1' => 'Convertir ce fichier GEDCOM format UTF-8 en format ISO-8859-1',
  'Convert to' => 'Convertir en',
  'Cook Islands' => 'Îles Cook',
  'Cookies' => 'Mouchards',
  'Copenhagen, Denmark' => 'Copenhague, Danemark',
  'Copy' => 'Copier',
  'Copy all the records from %1$s into %2$s.' => 'Copie tous les enregistrements de %1$s vers %2$s.',
  ...
  'Could not verify the information you entered. Please try again or contact the site administrator for more information.' => 'Identification impossible. Merci de réessayer.',
  ...
  'Create a submitter' => 'Créer un soumissionnaire',
  'Create a temporary folder…' => 'Crée un répertoire temporaire…',
  'Create a unique filename' => 'Créer un nom de dossier unique',
  'Create an individual' => 'Créer un nouvel individu',
  'Create your own chart' => 'Créez votre propre graphique',
  'Create, update, and delete a family tree for every GEDCOM file in the data folder.' => 'Crée, met à jour et supprime un arbre généalogique pour chaque fichier GEDCOM dans le dossier data.',
  'Cremation' => 'Crémation',
  ...
  'Database user account' => 'Identifiant de la base de données',
  'Date' => 'Date',
  ...
  'Date of blessing' => 'Date de la bénédiction',
  ...
  'Date of engagement' => 'Date de l’engagement',
  ...
  'Day' => 'Jour',
  'Day not set' => 'Jour absent',
  'Day:' => 'Jour&nbsp;:',
  'Dead' => 'Décédés',
  'Death' => 'Décès',
  'Death by country' => 'Décès par pays',
  'Death date range end' => 'Date de décès maxi',
  'Death date range start' => 'Date de décès mini',
  ...
  'Death of a son' => 'Décès du fils',
  'Death of a spouse' => 'Décès du conjoint',
  'Death of a wife' => 'Décès de l’épouse',
  ...
  'Delete' => 'Supprimer',
  'Delete all existing geographic data before importing the file.' => 'Supprimer toutes les données géographiques avant l’importation.',
  'Delete inactive users' => 'Supprimer un utilisateur',
  ...
  'Deleting the family will unlink all of the individuals from each other but will leave the individuals in place. Are you sure you want to delete this family?' => 'La suppression de cette famille enlèvera les liens entre les individus mais ces derniers ne seront pas effacés. Voulez-vous vraiment supprimer cette famille&nbsp;?',
  ...
  'Details' => 'Détails',
  'Details of the new user will be sent to the genealogy contact for the corresponding family tree.' => 'Les détails du nouvel utilisateur seront envoyés au référent en généalogie assigné à l’arbre généalogique.',
  ...
  'Djibouti' => 'Djibouti',
  'Do not seal, previous sealing canceled' => 'Ne pas sceller&nbsp;: précédent scellement annulé',
  ...
  'Edit preferences' => 'Modifier les paramètres',
  'Edit the FAQ' => 'Editer cette FAQ',
  'Edit the gender' => 'Modifier le sexe',
  'Edit the name' => 'Modifier le nom',
  'Edit the raw GEDCOM' => 'Modifier les balises GEDCOM',
  'Edit the shared note' => 'Modifier note partagée',
  'Edit the story' => 'Modifier l’histoire',
  'Edit the user' => 'Éditer l’utilisateur',
  'Edit this individual and replace their details with your own.' => 'Modifier cette personne et remplacer ses données par les vôtres.',
  'Editing restriction' => 'Restriction de modification',
  'Editor' => 'Éditeur',
  ...
  'End year' => 'Année fin',
  'Ending range of change dates' => 'Date maxi des modifications',
  'Endowment House' => 'Chambre de dotation',
  'Engagement' => 'Engagement',
  'England' => 'Angleterre',
  'Enter an optional note about this favorite' => 'Entrer un commentaire pour ce favori',
  'Entire record' => 'Enregistrement complet',
  'Equatorial Guinea' => 'Guinée équatoriale',
  'Eritrea' => 'Érythrée',
  'Error: converting GEDCOM files from %s encoding to UTF-8 encoding not currently supported.' => 'Erreur&nbsp;: la conversion du fichier GEDCOM %s à partir d’encodage UTF-8 ne sont pas actuellement pris en charge.',
  ...
  'Exclude individuals with “%s” as a married name' => 'Exclure les personnes avec des «&nbsp;%s&nbsp;» comme un nom de femme mariée',
  ...
  'Export' => 'Exporter',
  'Export a GEDCOM file' => 'Exporter un fichier GEDCOM',
  'Export all the family trees to GEDCOM files…' => 'Exporter tous les arbres vers les fichiers GEDCOM…',
  'Export preferences' => 'Paramètres d’exportation',
  ...
  'F.A.B.' => 'F.A.B.',
  'FAQ' => 'Aide FAQ',
  'FAQs are lists of questions and answers, which allow you to explain the site’s rules, policies, and procedures to your visitors. Questions are typically concerned with privacy, copyright, user-accounts, unsuitable content, requirement for source-citations, etc.' => 'FAQs sont des listes de questions et réponses qui vous permettent d’expliquer les règles du site, les politiques et les procédures à vos visiteurs. Les questions concernent généralement la vie privée, les droits d’auteur, les comptes utilisateurs, les contenus inappropriés, les exigences à ajouter la source de l’information, etc.',
  'Fact' => 'Fait',
  'Fact 1' => 'Fait 1',
  'Fact 10' => 'Fait 10',
  'Fact 11' => 'Fait 11',
  ...
  'Family with foster parents' => 'Famille avec des parents nourriciers',
  ...
  'Filenames are not allowed to have the extension “%s”.' => 'Les noms de fichier ne doivent pas avoir l’extension «&nbsp;%s&nbsp;».',
  ...
  'Files marked with %s are required for proper operation and cannot be removed.' => 'Les fichiers marqués avec %s sont nécessaires au bon fonctionnement et ne peut pas être enlevé.',
  'Filter' => 'Filtre',
  'Find a source' => 'Chercher une source',
  'Find a special character' => 'Chercher un caractère spécial',
  'Find all possible relationships' => 'Trouver tous les liens de parenté possibles',
  ...
  'Find the closest relationships' => 'Trouver les plus proches liens de parenté',
  ...
  'Fix name slashes and spaces' => 'Correction des noms avec «&nbsp;slash&nbsp;» et espace',
  'Flag' => 'Drapeau',
  'Flanders' => 'Flandress',
  ...
  'Follow this link to verify your email address.' => 'Cliquer sur le lien pour valider votre adresse courriel.',
  'Font' => 'Police',
  'Footer' => 'Pied de page',
  'Footers' => 'Pieds de pages',
  'For example, if the GEDCOM file contains %1$s and webtrees expects to find %2$s in the media folder, then you would need to remove %3$s.' => 'Par exemple, si le fichier GEDCOM contient %1$s et que webtrees s’attend à trouver %2$s dans le dossier media, alors vous devrez enlever %3$s.',
  ...
  'For technical support or genealogy questions contact %s.' => 'Pour toutes questions, contacter l’administrateur %s.',
  ...
  'Fort Lauderdale, Florida, United States' => 'Fort Lauderdale, Florida, États-Unis',
  ...
  'Hello administrator…' => 'Bonjour à l’administrateur …',
  'Help' => 'Aide',
  ...
  'How much recursion to use when searching for relationships' => 'Combien de récursivité à utiliser lors de la recherche de relations de parenté',
  'Hungary' => 'Hongrie',
  'Husband' => 'Époux',
  ...
  'If an individual does not have a surname, no slashes are needed: <%s>Jón Einarsson<%s>' => 'Si un individu n’a aucun nom de famile, les barres obliques ne sont pas requises&nbsp;:&nbsp;<%s>Jón Einarsson<%s>',
  'If an individual has two separate surnames, both should be enclosed by slashes: <%s>José Antonio /Gómez/ /Iglesias/<%s>' => 'Si un individu a deux noms de famille séparés, chacun d’eux doit être enchassé dans des barres obliques&nbsp;:&nbsp;<%s>José Antonio /Gómez/ /Iglesias/<%s>',
  'If an individual was known by a nickname which is not part of their formal name, it should be enclosed by quotation marks. For example, <%s>John &quot;Nobby&quot; /Clark/<%s>.' => 'Si un individu a été connu sous un diminutif ou un sobriquet ne faisant pas partie de son nom officiel, il doit être enchâssé dans des guillemets. Par exemple, <%s>John &quot;Nobby&quot; /Clark/<%s>.',
  ...
  'If you are concerned that users might upload inappropriate images, you can restrict media uploads to managers only.' => 'Si vous craignez que des utilisateurs puissent téléverser des images non conformes, vous pouvez restreindre les téléversements aux gestionnaires seulement.',
  ...
  'If you have a large number of media files, you can organize them into folders and subfolders.' => 'Si vous avez un grand nombre de fichiers médias, vous pouvez les organiser en dossiers et sous-dossiers.',
  'If you have created media objects in webtrees, and have subsequently edited this GEDCOM file using genealogy software that deletes media objects, then select this option to merge the current media objects with the new GEDCOM file.' => 'Si vous avez créé des objets médias dans webtrees, et avez modifié votre GEDCOM hors-ligne en utilisant un programme qui supprime les objets médias, cochez cette case pour fusionner les objets média en cours avec le nouveau GEDCOM.',
  ...
  'If you use one of the following tracking and analytics services, webtrees can add the tracking codes automatically.' => 'Si vous utilisez un des services de suivi et d’analyse ci-dessous, webtrees peut ajouter automatiquement les codes de suivi.',
  ...
  'Import preferences' => 'Paramètres d’importation',
  ...
  'In many cultures it is customary to have a traditional name spelled in the traditional characters and also a romanized version of the name as it would be spelled or pronounced in languages based on the Latin alphabet, such as English.<br><br>If you prefer to use a non-Latin alphabet such as Hebrew, Greek, Russian, Chinese, or Arabic to enter the name in the standard name fields, then you can use this field to enter the same name using the Latin alphabet. Both versions of the name will appear in lists and charts.<br><br>Although this field is labeled “Romanized”, it is not restricted to containing only characters based on the Latin alphabet. This might be of use with Japanese names, where three different alphabets may occur.' => 'Dans beaucoup de cultures, il est usuel, d’avoir un nom traditionnel écrit en caractères traditionnels, et également une version romanisé du nom, comme il serait orthographié ou prononcé dans les langues basées sur l’alphabet latin, tel que l’anglais.<br><br>Si vous préférez employer un alphabet non-Latin tel l’hébreu, le grec, le russe, le chinois, ou l’arabe pour écrire le nom dans les zones d’identification standard, alors vous pouvez employer ce champ pour écrire le même nom en utilisant l’alphabet latin. Les deux versions du nom apparaîtront dans les listes et les diagrammes.<br><br>Bien que ce champ soit marqué «&nbsp;Romanisé&nbsp;», il n’est pas limité à ne contenir que des caractères basés sur l’alphabet latin. Ceci pourrait être utile avec des noms japonais, où trois alphabets différents peuvent coexistent.',
  ...
  'Include individuals with “%s” as a married name' => 'Inclure les personnes avec des «&nbsp;%s&nbsp;» comme un nom de femme mariée',
  ...
  'Individual distribution chart' => 'Diagramme de répartition des individus',
  'Individual page' => 'Page individuelle',
  'Individual pages' => 'Pages individuelles',
  'Individual record' => 'Code GEDCOM de l’individu',
  ...
  'Invalid GEDCOM file - no header record found.' => 'Fichier GEDCOM incorrect - absence d’en-tête dans l’enregistrement trouvé.',
  ...
  'Israel' => 'Israël',
  'It can take several minutes to download and install the upgrade. Be patient.' => 'Il peut prendre plusieurs minutes à télécharger et à installer la mise à jour. Soyez patient.',
  'Italy' => 'Italie',
  'GENITIVEIyar' => 'Iyar',
  ...
  'Kenya' => 'Kenya',
  'Keyword examples' => 'Exemples les mots-clés',
  ...
  'Leave this entry blank to keep the original filename' => 'Laisser cet espace vide pour conserver le nom du fichier original',
  'Leaves' => 'Feuilles',
  'Lebanon' => 'Liban',
  ...
  'Link media objects to facts and events' => 'Lier des objets média à des faits ou événements',
  'Link the user account to an individual.' => 'Relier ce compte utilisateur à la fiche d’un individu.',
  'Link this individual to an existing family as a child' => 'Relier cette personne à une famille existante comme enfant',
  ...
  'Link this user to an individual in the family tree.' => 'Associer cet utilisateur à un individu de l’arbre généalogique.',
  ...
  'Map' => 'Plan/Carte',
  'Map provider' => 'Fournisseur de cartes',
  ...
  'Marriage date range end' => 'Date de mariage maxi',
  'Marriage date range start' => 'Date de mariage mini',
  'Marriage ending status' => 'Statut de fin de mariage',
  'Marriage intention' => 'Promesse de mariage',
  'Marriage license' => 'Licence de mariage',
  'Marriage of a brother' => 'Mariage du frère',
  ...
  'Marriage type unknown' => 'Type de mariage inconnu',
  'Marriages' => 'Mariages',
  'Marriages by century' => 'Mariages par siècle',
  'Married name' => 'Nom après mariage',
  'Married surname' => 'Nom de famille après mariage',
  'Marshall Islands' => 'Îles Marshall',
  'Martinique' => 'Martinique',
  'Masquerade as this user' => 'Prétendre être cet utilisateur',
  'Match both upper and lower case letters.' => 'Faire correspondre à la fois des majuscules et des minuscules.',
  ...
  'Maximum upload size: ' => 'Taille maxi pour le téléversement ',
  ...
  'Media filenames will be prefixed by %s.' => 'Le préfixe des fichiers médias sera %s.',
  ...
  'Mediterranio' => 'Bleu méditerranée',
  ...
  'Mercury' => 'Mercure',
  'Merge' => 'Fusionner',
  'Merge family trees' => 'Fusionner des arbres',
  'Merge records' => 'Fusionner des items',
  ...
  'Month of birth of first child in a relation' => 'mois de naissance ou du premier enfant obtenu par une relation',
  ...
  'Most common surnames' => 'Principaux noms de familles',
  ...
  'Most sites are configured to use localhost. This means that your database runs on the same computer as your web server.' => 'La plupart des sites utilise localhost comme nom d’hôte. Cela signifie que votre base de données est hébergée sur le même ordinateur que votre serveur Web.',
  'Most sites are configured to use the default value of 1433.' => 'La plupart des sites utilisent la valeur 1433 par défaut.',
  'Most sites are configured to use the default value of 3306.' => 'La plupart des sites utilisent la valeur par défaut 3306.',
  ...
  'Name suffix' => 'Suffix du nom',
  'Names' => 'Noms',
  'Namesake' => 'Homonyme',
  'Namibia' => 'Namibie',
  'Nanny' => 'Bonne d’enfants',
  ...
  'Nicaragua' => 'Nicaragua',
  'Nickname' => 'Diminutif ou Sobriquet',
  'Niger' => 'Niger',
  'Nigeria' => 'Nigéria',
  ...
  'No' => 'Non',
  'No GEDCOM file was received.' => 'Aucun fichier GEDCOM reçu.',
  'No GEDCOM files found.' => 'Aucun fichier GEDCOM trouvé.',
  'No calendar conversion' => 'Aucune conversion de calendrier',
  'No children' => 'Aucun enfant',
  'No contact' => 'Aucun contact',
  'No duplicates have been found.' => 'Aucun doublon trouvé.',
  'No errors have been found.' => 'Aucune erreur trouvée.',
  'No events exist for the next %s day.' . "\0" . 'No events exist for the next %s days.' => 'Aucun événement dans le prochain %s jour.' . "\0" . 'Aucun événement dans les %s prochains jours.',
  ...
  'No link between the two individuals could be found.' => 'Aucun (autre) lien trouvé entre les deux individus.',
  ...
  'Normally, any changes made to a family tree need to be reviewed by a moderator. This option allows a user to make changes without needing a moderator.' => 'Normalement, toutes modifications faites à un arbre généalogique doivent être révisées par un modérateur. Cette option permet à un utilisateur d’effectuer des modifications sans l’approbation d’un modérateur.',
  ...
  'Note' => 'Note',
  'Note that if a user account is linked to a record, then that user will always be able to view that record.' => 'Notez que si un compte d’utilisateur est lié à une fiche, alors l’utilisateur sera toujours en mesure d’afficher ce dossier.',
  ...
  'Nothing found.' => 'Rien trouvé ou tâche complétée.',
  ...
  'Number of surnames' => 'Nombre de noms de famille',
  'Nurse' => 'Garde-malade',
  ...
  'Old files found' => 'Vieux fichiers trouvés',
  ...
  'Ordinance' => 'SDJ&nbsp;: cérémonie',
  'Ordination' => 'Ordination',
  'Orientation' => 'Orientation',
  'Orlando, Florida, United States' => 'Orlando, Floride, États-Unis',
  'Other' => 'Autres',
  'Other facts to show in charts' => 'Autres évènements à afficher dans les tableaux',
  'Other preferences' => 'Autres paramètres',
  'Owner' => 'Propriétaire',
  ...
  'Place names should be entered as a comma-separated list, starting with the smallest place and ending with the country. For example, “Westminster, London, England”.' => 'Les noms de lieux doivent être saisis sous forme de liste séparés par des virgules, en commençant par le plus petit lieu pour finir par le pays. Par exemple, « Westminster, Londres, Angleterre ».',
  ...
  'Place of blessing' => 'Lieu de la bénédiction',
  ...
  'Place of engagement' => 'Lieu de l’engagement',
  ...
  'Preferences exist for the module “%s”, but this module no longer exists.' => 'Des préférences sont définies pour le module «&nbsp;%s&nbsp;», mais celui-ci n’existe plus.',
  ...
  'Related families' => 'Proches parents',
  ...
  'Relationship to parents' => 'Lien parental',
  'Relationship: %s' => 'Parenté&nbsp;: %s',
  'Relationships' => 'Parenté',
  'Relationships between %1$s and %2$s' => 'Parenté entre %1$s et %2$s',
  'Religion' => 'Religion',
  ...
  'Remove the GEDCOM media path from filenames' => 'Enlever le chemin media du GEDCOM dans les noms des fichiers medias',
  'Remove this location?' => 'Supprimer ce lieu&nbsp;?',
  'Reno, Nevada, United States' => 'Reno, Nevada, États-Unis',
  'Renumber' => 'Numéroter à nouveau',
  ...
  'Research tasks are stored using the custom GEDCOM tag “_TODO”. Other genealogy applications may not recognize this tag.' => 'Les tâches à faire sont stockées sous la balise GEDCOM standard «&nbsp;_TODO&nbsp;». D’autres logiciels de généalogie peuvent ne pas reconnaître cette balise.',
  ...
  'Restrictions can be added to records and/or facts. They restrict who can view the data and who can edit it.' => 'Des restrictions peuvent être ajoutées aux enregistrements et/ou aux faits. Ils restreignent l’accès à qui peut voir et qui peut modifier les données.',
  'Results' => 'Résultats',
  'Retirement' => 'Retraite',
  'Reunion' => 'Réunion',
  ...
  'Rwanda' => 'Rwanda',
  'SMTP mail server' => 'Serveur mail SMTP',
  ...
  'Same as uploaded file' => 'Identique à un fichier téléversé',
  'Samoa' => 'Samoa',
  ...
  'Second record' => 'Deuxième enregistrement',
  'Secure connection' => 'SSL requis',
  'Security code' => 'Code de sécurité',
  'See %s for more information.' => 'Voir %s pour plus d’information.',
  'Select' => 'Sélectionner',
  'Select a GEDCOM file to import' => 'Sélectionnez un fichier GEDCOM à importer',
  'Select a date' => 'Choisir une date',
  'Select individuals by place or date' => 'Choisir des individus par lieu ou par date',
  'Select records from your family tree and save them as a GEDCOM file.' => 'Sélectionner les documents de votre arbre généalogique et les enregistrer dans un fichier GEDCOM.',
  'Select the desired age interval' => 'Sélectionnez l’intervalle d’âge souhaité',
  'Select the facts and events to keep from both records.' => 'Sélectionner les faits et événements à conserver dans les deux enregistrements.',
  ...
  'Server information' => 'Détails du serveur',
  'Server name' => 'Nom du serveur',
  'Set a new password' => 'Définir un nouveau mot de passe',
  'Set as default' => 'Définir par défaut',
  'Set the access level for each tree.' => 'Définir le niveau d’accès de chaque arbre.',
  ...
  'Set the status to “approved”.' => 'Définir le statut à «&nbsp;approuver&nbsp;».',
  'Setting this to <b>Yes</b> will place links on individuals, sources, and families to let users bring up another window containing the raw data taken right out of the GEDCOM file.' => 'Régler cette option à <b>Oui</b> placera des liens sur les individus, les sources et les familles pour autoriser les utilisateurs à ouvrir une fenêtre contenant le code GEDCOM extrait du fichier.',
  ...
  'Show' => 'Afficher',
  'Show a download link in the media viewer' => 'Voir lien de téléchargement dans «&nbsp;media viewer&nbsp;»',
  ...
  'Show all sources' => 'Voir toutes les sources',
  'Show an age cursor' => 'Afficher un curseur indiquant l’âge',
  'Show children of ancestors' => 'Afficher les enfants des ancêtres',
  'Show couples where either partner married more than once.' => 'Afficher les couples où les deux conjoints se sont mariés plus d’une fois.',
  'Show couples where only the female partner is dead.' => 'Affichage des couples dont seule la femme est décédée en date d’aujourd’hui.',
  'Show couples where only the male partner is dead.' => 'Affichage des couples dont seul le conjoint est décédé en date d’aujourd’hui.',
  ...
  'Show dead individuals' => 'Montrer les personnes décédées',
  ...
  'Show individuals who are alive or couples where both partners are alive.' => 'Affichage des personnes vivantes ou des couples dont les deux conjoints sont vivants en date d’aujourd’hui.',
  'Show individuals who are dead or couples where both partners are dead.' => 'Affichage des personnes décédées ou des couples dont les deux conjoints sont décédés en date d’aujourd’hui.',
  ...
  'Show living individuals' => 'Montrer les individus vivants',
  'Show names of private individuals' => 'Montrer les noms des individus privés',
  'Show notes' => 'Montrer les notes',
  'Show occupations' => 'Afficher les professions',
  'Show only events of living individuals' => 'Voir seulement les personnes vivantes',
  ...
  'Show only individuals, events, or all' => 'Montrer seulement les personnes, les événements ou tout',
  ...
  'Show photos' => 'Montrer les photos',
  ...
  'Show sources' => 'Montrer les sources',
  'Show spouses' => 'Afficher les conjoints',
  'Show statistics charts' => 'Afficher les tableaux de statistiques',
  'Show the %1$s %2$s parts of a place name.' => 'Afficher les %1$s %2$s parties du nom d’un lieu.',
  'Show the birthplace of ancestors on a map.' => 'Afficher le lieu de naissance des ancêtres sur la carte.',
  'Show the date and time of update' => 'Afficher la date et l’heure de mise à jour',
  'Show the events of close relatives on the individual page' => 'Ajoute les évènements de la famille proche à la page individuelle',
  'Show the family tree' => 'Montrer l’arbre généalogique',
  ...
  'Show the location of events on a map.' => 'Montrer le lieu des événements sur la carte.',
  ...
  'Show thumbnail images in charts and family groups.' => 'Afficher les vignettes des individus dans les diagrammes et les familles.',
  'Show to managers' => 'Montrer aux gestionnaires',
  'Show to members' => 'Montrer aux membres',
  'Show to visitors' => 'Montrer aux visiteurs',
  'Show “leaves” couples or individuals. These are individuals who are alive but have no children recorded in the database.' => 'Affichage des couples ou individus «&nbspfeuilles&nbsp;», c’est-à-dire&nbsp;: vivants à la date d’aujourd’hui mais n’ayant pas d’enfant enregistré dans la base.',
  ...
  'Sign-in and registration' => 'Connexion et abonnement',
  ...
  'Site members can send each other messages. You can choose to how these messages are sent to you, or choose not receive them at all.' => 'Les membres peuvent s’envoyer mutuellement des messages. Vous pouvez choisir la méthode d’envoi de ces messages, ou choisir de ne pas en recevoir.',
  'Site verification code' => 'Code de vérification du site',
  'Site verification codes do not work when webtrees is installed in a subfolder.' => 'Les codes de vérification de site ne fonctionnent pas quand webtrees est installé dans un sous-dossier.',
  ...
  'Somalia' => 'Somalie',
  'Some genealogy software creates GEDCOM files that contain media filenames with full paths. These paths will not exist on the web-server. To allow webtrees to find the file, the first part of the path must be removed.' => 'Certains logiciels de généalogie créent des fichiers GEDCOM contenant des noms de fichiers médias avec les chemins complets. Ces chemins n’existeront pas sur le serveur web. Pour permettre à webtrees de trouver les fichiers, la première partie du chemin doit être enlevée.',
  'Some pages can display the number of times that they have been visited.' => 'Certaines pages peuvent afficher le nombre de fois qu’elles ont été vues.',
  ...
  'Source type' => 'Enregistrer les sources au niveau des évènements',
  'Sources' => 'Sources',
  ...
  'Starting range of change dates' => 'Date mini des modifications',
  'State' => 'État',
  ...
  'Surname distribution chart' => 'Diagramme de répartition des prénoms',
  'Surname list style' => 'Style de présentation des listes',
  'Surname option' => 'Option Nom',
  ...
  'Text' => 'Texte',
  'Thailand' => 'Thaïlande',
  'The <b>name</b> field contains the individual’s full name, as they would have spelled it or as it was recorded. This is how it will be displayed on screen. It uses standard genealogy annotations to identify different parts of the name.' => 'Le champ <b>nom</b> contient le nom complet de l’individu, tel qu’il l’épellerait ou comme il a été écrit dans le document. C’est le nom qui sera affiché à l’écran. Les annotations généalogiques standards sont utilisées pour identifier les différentes parties du nom.',
  ...
  'The PHP temporary folder is missing.' => 'Le dossier temporaire PHP est manquant.',
  ...
  'The clippings cart allows you to take extracts from this family tree and download them as a GEDCOM file.' => 'Le panier vous permet de prendre des extraits de cet arbre généalogique et de les télécharger en un fichier au format GEDCOM.',
  ...
  'The file %s could not be deleted.' => 'Le fichier %s ne peut pas être supprimé.',
  'The file %s has been deleted.' => 'Le fichier %s a été supprimé.',
  'The file %s has been uploaded.' => 'Le fichier %s a été téléversé.',
  'The file was only partially uploaded. Please try again.' => 'Fichier reçu partiellement. Veuillez recommencer.',
  ...
  'The following facts and events were found in both records.' => 'Les faits et événements suivants ont été trouvé dans les deux enregistrements.',
  'The following facts and events were only found in the record of %s.' => 'Les faits et événements suivants ont été trouvés uniquement dans l’enregistrement de %s.',
  ...
  'The link from “%1$s” to “%2$s” has been updated.' => 'Le lien de «&nbsp;%1$s&nbsp;» à «&nbsp;%2$s&nbsp;» a été mis à jour.',
  ...
  'The memory and CPU time requirements depend on the number of individuals in your family tree.' => 'La mémoire et le temps maximum d’exécution requis dépendent du nombre d’individus dans votre arbre.',
  ...
  'The most common family facts and events are listed separately, so that they can be added more easily.' => 'Les faits et événements les plus courants relatifs aux familles sont listés séparément, afin d’être ajoutés plus facilement.',
  'The most common individual facts and events are listed separately, so that they can be added more easily.' => 'Les faits et événements les plus courants relatifs aux individus sont listés séparément, afin d’être ajoutés plus facilement.',
  'The most common repository facts are listed separately, so that they can be added more easily.' => 'Les faits les plus courants relatifs aux dépôts d’archives sont listés séparément, afin d’être ajoutés plus facilement.',
  'The most common source facts are listed separately, so that they can be added more easily.' => 'Les faits les plus courants relatifs aux sources sont listés séparément, afin d’être ajoutés plus facilement.',
  ...
  'The password needs to be at least six characters long.' => 'Le mot de passe doit comporter au moins six caractères.',
  ...
  'The preferences for the family tree “%s” have been updated.' => 'Les préférences de l’arbre généalogique «&nbsp;%s&nbsp;» ont été mises à jour.',
  ...
  'The repository has been created' => 'Le répertoire a été créé',
  ...
  'The size of the family tree, earliest and latest events, common names, etc.' => 'La dimension de l’arbre généalogique, les événements les plus récents et les plus anciens, les noms les plus fréquents, etc.',
  'The source has been created' => 'La source a été créée',
  'The submitter has been created' => 'Le fournisseur a été créé',
  'The surname is enclosed by slashes: <%s>John Paul /Smith/<%s>' => 'Le nom de famille est enchâssé dans des barres obliques&nbsp;:&nbsp;<%s>John Paul /Smith/<%s>',
  'The time zone is required for date calculations, such as knowing today’s date.' => 'Le fuseau horaire est requis pour les calculs de la date, comme connaître la date du jour.',
  ...
  'The upgrade is complete.' => 'La mise à jour est complétée.',
  ...
  'The website preferences have been updated.' => 'Les préférences du site ont été mises à jour.',
  'The website www.geonames.org provides a large database of place names. This can be searched when entering new places. To use this feature, you must register for a free account at www.geonames.org and provide the username.' => 'Ce site Internet www.geonames.org contient une importante base de données de noms de lieux. Celle-ci peut être recherchée lors de l’ajout de nouveaux lieux. Afin d’utiliser cette fonctionnalité, vous devez ouvrir un compte gratuit sur www.geonames.org et fournir le nom d’utilisateur.',
  ...
  'Themes' => 'Thèmes',
  'There are no facts for this individual.' => 'Aucun fait lié à cet individu.',
  ...
  'There are no pending changes.' => 'Il n’y a pas de modifications en attente d’approbation.',
  ...
  'There was an error uploading your file.' => 'Erreur lors du téléversement de votre fichier GEDCOM.',
  ...
  'This account has not been approved. Please wait for an administrator to approve it.' => 'Ce compte n’a pas encore été approuvé. Veuillez, s’il-vous-plaît, attendre l’approbation de l’administrateur.',
  'This account has not been verified. Please check your email for a verification message.' => 'Ce compte n’a pas encore été vérifié. Veuillez, s’il-vous-plaît, vérifier votre boîte-courriel et lire le message de vérification.',
  ...
  'This family has been edited. You should review the changes and then %1$s or %2$s them.' => 'Cette famille a été éditée. Vous devriez examiner les modifications, puis les %1$s ou les %2$s.',
  ...
  'This individual has been deleted. You should review the deletion and then %1$s or %2$s it.' => 'Cet individu a été supprimé. Vous devriez examiner la suppression puis l’%1$s ou le %2$s.',
  ...
  'This individual has been edited. You should review the changes and then %1$s or %2$s them.' => 'Cet individu a été édité. Vous devriez examiner les modifications, puis les %1$s ou les %2$s.',
  'This individual will be selected by default when viewing charts and reports.' => 'Cet individu sera utilisé par défaut pour l’affichage des grahiques et des rapports.',
  'This information is not available.' => 'Cette information n’est pas disponible.',
  'This information is private and cannot be shown.' => 'Respect des règles de confidentialité&nbsp;: les détails de cet enregistrement ne sont pas affichés.',
  'This is a comma separated list of GEDCOM fact tags that will be shown on the add/edit name form. If you use non-Latin alphabets such as Hebrew, Greek, Cyrillic, or Arabic, you may want to add tags such as _HEB, ROMN, FONE, etc. to allow you to store names in several different alphabets.' => 'Ceci est une liste de balises des faits GEDCOM séparées par des virgules qui sera affichée sur le formulaire Ajouter/Modifier le nom. Si vous utilisez des alphabets non-latins comme l’hébreu, le grec, le cyrillique ou l’arabe, vous pouvez ajouter des balises telles que _HEB, ROMN, FONE, etc pour vous permettre d’enregistrer les noms de plusieurs alphabets différents.',
  ...
  'This is a comma separated list of GEDCOM fact tags that will be shown when you add or edit place names. If you use non-Latin alphabets such as Hebrew, Greek, Cyrillic, or Arabic, you may want to add tags such as _HEB, ROMN, FONE, etc. to allow you to store place names in several different alphabets.' => 'Il s’agit d’une liste séparée par des virgules de balises GEDCOM fait qui sera affiché lorsque vous ajoutez ou modifiez les noms de lieux. Si vous utilisez des alphabets non latins comme l’hébreu, grec, cyrillique ou arabe, vous pouvez ajouter de tags tels que _HEB, ROMN, FONE, etc pour vous permettre d’enregistrer les noms de lieu dans plusieurs alphabets différents.',
  'This is a link to your own record in the family tree. If this is the wrong individual, contact an administrator.' => 'Il s’agit d’un lien vers vos propre information dans l’arbre généalogique. Si ce n’est pas la bonne personne, contactez un administrateur.',
  'This is case sensitive.' => 'Sensible à la casse.',
  'This is the latest version of webtrees. No upgrade is available.' => 'Ceci est la dernière version de webtrees. Aucune mise à jour disponible.',
  ...
  'This is the name of the SMTP server. “localhost” means that the mail service is running on the same computer as your web server.' => 'Il s’agit du nom du serveur SMTP. «&nbsp;localhost&nbsp;» signifie que le service mail est hébergé sur le même ordinateur que le serveur de votre site Web.',
  'This is your real name, as you would like it displayed on screen.' => 'Ceci est votre nom, tel que vous aimeriez le voir à l’écran.',
  ...
  'This media object has been edited. You should review the changes and then %1$s or %2$s them.' => 'Cet objet média a été édité. Vous devez examiner les modifications et puis les %1$s ou les %2$s.',
  ...
  'This note has been deleted. You should review the deletion and then %1$s or %2$s it.' => 'Cette note a été supprimée. Vous devriez examiner la suppression puis l’%1$s ou la %2$s.',
  ...
  'This note has been edited. You should review the changes and then %1$s or %2$s them.' => 'Cette note a été éditée. Vous devriez examiner les modifications, puis les %1$s ou les %2$s.',
  ...
  'This option will make it easier for users to download images.' => 'Cette option facilite le téléchargement d’images par les utilisateurs.',
  'This option will retain family links in private records. This means that you will see empty “private” boxes on the pedigree chart and on other charts with private individuals.' => 'Cette option conserve les liens familiaux dans les dossiers privés. Cela signifie que vous pourrez voir les boîtes vides «&nbsp;privé&nbsp;» sur le tableau généalogique et sur les autres tableaux avec les personnes privées.',
  ...
  'This record does not exist or you do not have permission to view it.' => 'Cet enregistrement n’existe pas ou vous n’avez pas la permission de le voir.',
  'This record does not exist.' => 'Cet enregistrement n’existe pas.',
  'This record has been deleted. The deletion will need to be reviewed by a moderator.' => 'Cet enregistrement a été supprimé. La suppression doit être vérifiée par un modérateur.',
  'This record has been deleted. You should review the deletion and then %1$s or %2$s it.' => 'Cet enregistrement a été supprimé. Vous devez vérifier la suppression et ensuite l’ %1$s ou la %2$s.',
  'This record has been edited. The changes need to be reviewed by a moderator.' => 'Cet enregistrement a été modifié. Le changement doit être révisé par un modérateur.',
  'This record has been edited. You should review the changes and then %1$s or %2$s them.' => 'Cet enregistrement a été modifié. You devez réviser les changements et ensuite les %1$s ou les %2$s.',
  ...
  'This repository has been edited. You should review the changes and then %1$s or %2$s them.' => 'Ce dépôt a été édité. Vous devriez examiner les modifications, puis les %1$s ou les %2$s.',
  ...
  'This role has all the permissions of the editor role, plus permission to accept/reject changes made by other users.' => 'Ce rôle a toutes les autorisations du rôle d’éditeur, ainsi que d’approuver/refuser les modifications apportées par d’autres utilisateurs.',
  ...
  'This role has all the permissions of the member role, plus permission to add/change/delete data. Any changes will need to be reviewed by a moderator, unless the user has the “automatically accept changes” option enabled.' => 'Ce rôle a toutes les autorisations du rôle de membre, ainsi que la permission d’ajouter/modifier/supprimer des données. Tout changement devra être approuvé par un modérateur, sauf si pour l’utilisateur l’option «&nbsp;accepter automatiquement les modifications&nbsp;» est activée.',
  'This role has all the permissions of the moderator role, plus any additional access granted by the family tree configuration, plus permission to change the settings/configuration of a family tree.' => 'Ce rôle a toutes les autorisations du rôle du modérateur, plus l’accès à la configuration l’arbre généalogique, plus l’autorisation de modifier les paramètres / configuration d’un arbre généalogique.',
  ...
  'This server’s memory limit is %s MB and its CPU time limit is %s seconds.' => 'La limite de mémoire RAM du serveur est %s Mo, et le temps maximal d’exécution est de %s secondes.',
  ...
  'This source has been edited. You should review the changes and then %1$s or %2$s them.' => 'Cette source a été édité. Vous devriez examiner les modifications, puis les %1$s ou les %2$s.',
  ...
  'This type of link is not allowed here.' => 'Ce type de lien n’est pas permis ici.',
  ...
  'This website uses cookies to learn about visitor behavior.' => 'Ce site utilise des mouchards pour connaître le comportement des visiteurs.',
  ...
  'This will delete all the genealogy data from “%s” and replace it with data from a GEDCOM file.' => 'Toutes les données généalogiques de «&nbsp;%s&nbsp;» seront effacées, elles seront remplacées par les données provenant d’un autre GEDCOM.',
  'Thu' => 'Jeu',
  ...
  'To reduce the size of the download, you can compress the data into a .ZIP file. You will need to uncompress the .ZIP file before you can use it.' => 'Pour réduire le volume du téléchargement, vous pouvez compresser les données dans un fichier .ZIP. Vous devrez extraire les données du fichier .ZIP afin de pouvoir les utiliser.',
  'To set a new password, follow this link.' => 'Pour définir un nouveau mot de passe, suivez ce lien.',
  'To set this text for other languages, you must switch to that language, and visit this page again.' => 'Pour définir ce texte dans une autre langue, il faut sélectionner cette langue puis revenir sur cette page.',
  'To tell search engines that sitemaps are available, you can use the following links.' => 'Pour dire aux moteurs de recherche que les cartes du site sont disponibles, vous pouvez utiliser les liens suivants.',
  'Togo' => 'Togo',
  'Tokelau' => 'Tokélaou',
  'Tokyo, Japan' => 'Tokyo, Japon',
  'Tombstone' => 'Pierre tombale',
  'Tonga' => 'Tonga',
  'Top %s given name' . "\0" . 'Top %s given names' => 'Top des %s prénom' . "\0" . 'Top des %s prénoms',
  'Top %s surname' . "\0" . 'Top %s surnames' => 'Top des %s noms de famille' . "\0" . 'Top des %s noms de familles',
  'Top given name' => 'Le prénom le plus répandu',
  'Top given names' => 'Les prénoms les plus répandus',
  'Top surname' => 'Nom de famille le plus répandu',
  'Top surnames' => 'Noms de famille les plus répandus',
  'Toronto, Ontario, Canada' => 'Toronto, Ontario, Canada',
  'Total' => 'Total',
  'Total accepted changes: ' => 'Total des modifications approuvées&nbsp;: ',
  ...
  'Tracking and analytics' => 'Suivi et analyses',
  ...
  'Unique identifiers allow the same record to be found in different family trees and in different systems. They will be added whenever records are created or updated. If you do not want unique identifiers to be displayed, you can hide them using the privacy rules.' => 'Les identificateurs uniques permettent à un même enregistrement d’être dans des arbres généalogiques et dans des systèmes différents. Ils seront ajoutés quand l’enregistrement sera créé ou mis à jour. Si vous ne désirez pas afficher les identifiants uniques, vous pouvez les masquer en utilisant les règles de confidentialité.',
  ...
  'Unzip %s to a temporary folder…' => 'Décompresser %s vers un dossier temporaire…',
  ...
  'Upgrade to webtrees %s.' => 'Mettre à jour à la version %s de webtrees.',
  'Upgrade wizard' => 'Assistant de mise à jour',
  'Upload media files' => 'Téléverser un fichier',
  'Upload one or more media files from your local computer. Media files can be pictures, video, audio, or other formats.' => 'Téléverser un ou plusieurs fichiers média. Les fichiers peuvent être des images, des vidéos, des sons ou autres.',
  'Uruguay' => 'Uruguay',
  'Use SMTP to send messages' => 'Utiliser un serveur SMTP pour envoyer les messages',
  'Use a “?” to match a single character, use “*” to match zero or more characters.' => 'Utiliser un «&nbsp;?&nbsp;» correspond à un seul caractère, utiliser «&nbsp;*&nbsp;» correspond à zéro ou plusieurs caractères.',
  ...
  'Use full source citations' => 'Enregistrer tous les détails des sources',
  ...
  'Use sendmail to send messages' => 'Utiliser sendmail pour envoyer des messages',
  'Use silhouette images when no highlighted image for that individual has been specified. The images used are specific to the gender of the individual in question.' => 'Utiliser une silhouette quand aucune image principale n’a été définie pour cet individu. Les images utilisées comme silhouettes correspondent au sexe de l’individu concerné.',
  'Use silhouettes' => 'Utilisez les silhouettes',
  ...
  'Use this image for charts and on the individual’s page.' => 'Utiliser cette image pour les diagrammes et sur la page d’un individu.',
  ...
  'View this day' => 'Voir ce jour',
  'View this family' => 'Afficher la famille',
  'View this month' => 'Voir ce mois',
  'View this year' => 'Voir cette année',
  ...
  'When a record is edited, the user and timestamp are recorded. Sometimes it is desirable to keep the existing “last change” information, for example when making minor corrections to someone else’s data. This option controls whether this feature is selected by default.' => 'Quand un enregistrement est modifié, l’utilisateur et l’estampille temporelle (horodatage) sont enregistrés. Parfois on souhaite conserver l’information existante de la «&nbsp;dernière modification&nbsp;», par exemple si on apporte des corrections mineures à des données d’un autre utilisateur. Cette option détermine si la fonction est active par défaut.',
  'When a user registers for an account, an email is sent to their email address with a verification link. When they follow this link, we know the email address is correct, and the “email verified” option is selected automatically.' => 'Quand un utilisateur s’inscrit pour un compte, un courriel contenant un lien de vérification est envoyé à son adresse. Quand il clique sur ce lien, nous savons que l’adresse courriel est valide, et l’option «&nbsp;courriel vérifiée&nbsp;» est sélectionnée automatiquement.',
  ...
  'Who can upload new media files' => 'Qui peut téléverser de nouveaux fichiers média',
  ...
  'Wife’s surname replaced by husband’s surname' => 'Nom de famille de l’épouse remplacé par celui du mari',
  'Will' => 'Testament',
  ...
  'You are not allowed to send messages that contain external links.' => 'Vous n’êtes pas autorisé à envoyer des messages contenant des liens externes.',
  'You are signed in as %s.' => 'Vous êtes connecté en tant que %s.',
  'You can apply for an account using the link below.' => 'Vous pouvez demander un compte en utilisant le lien ci-dessous.',
  'You can change the appearance of webtrees using “themes”. Each theme has a different style, layout, color scheme, etc.' => 'Vous pouvez changer l’apparence de webtrees à l’aide des «&nbsp;thèmes&nbsp;». Chaque thème a un style différent, l’aménagement, de couleurs, etc.',
  'You can choose whether to appear in the list of users who are currently signed-in.' => 'Vous pouvez choisir d’apparaître ou non dans la liste des utilisateurs connectés.',
  'You can download a copy of the GEDCOM specification from %s.' => 'Vous pouvez télécharger une copie des normes GEDCOM à partir de %s.',
  'You can make it easier to search for married women by recording their married name. However not all women take their husband’s surname, so beware of introducing incorrect information into your database.' => 'Vous pouvez faciliter la recherche de femmes mariées en enregistrant leur nom utilisé après mariage. Cependant toutes les femmes ne prennent pas le nom de leur mari, alors méfiez-vous de l’introduction d’informations incorrectes dans votre base de données.',
  ...
  'You cannot sign in because your browser does not accept cookies.' => 'Vous ne pouvez vous connecter car votre navigateur n’accepte pas les mouchards.',
  ...
  'You must select an individual and a chart type in the block preferences' => 'Vous devez sélectionner un individu et le type de graphique dans les paramètres du bloc',
  ...
  'You need to be a family member to access this website.' => 'Vous devez être un membre de la famille pour accéder à ce site.',
  'You need to be an authorized user to access this website.' => 'Vous devez être un utilisateur autorisé pour accéder à ce site.',
  'You need to create a family tree.' => 'Vous devez créer un arbre généalogique.',
  'You need to review the account details.' => 'Vous devez réviser les détails du compte.',
  'You need to set up an administrator account. This account can control all aspects of this webtrees installation. Please choose a strong password.' => 'Vous devez créer un compte d’administrateur. Ce compte peut contrôler tous les aspects de cette installation de webtrees. Veuillez choisir un mot de passe difficile à deviner.',
  ...
  'You should not approve an account unless you know that the email address is correct.' => 'Vous ne devez pas approuver un compte si vous ne savez que l’adresse courriel est correcte.',
  ...
  'Your user account does not have “automatically accept changes” enabled. You will only be able to change one record at a time.' => 'Votre compte utilisateur ne peut pas «&nbsp;approuver automatiquement les changements&nbsp;». Vous devez effectuer une seule modification à la fois.',
  'Your web server is using PHP version %s, which is no longer receiving security updates. You should upgrade to a later version as soon as possible.' => 'Votre serveur web utilise une version PHP %s qui ne reçoit plus de mises à jour de sécurité. Vous devez passer à une version plus récente dès que possible.',
  'Zambia' => 'Zambie',
  'Zimbabwe' => 'Zimbabwe',
  'Zoom' => 'Zoom',
  'Zoom in' => 'Zoom avant',
  ...
  'after %s' => 'après %s',
  'age' => 'âge',
  'also known as' => 'également connu sous',
  ...
  'edit' => 'éditer',
  'eighth cousin' => '8<sup>e</sup> arrière-petit(e)-cousin(e)',
  ...
  'eleventh cousin' => '11<sup>e</sup> arrière-petit(e)-cousin(e)',
  ...
  'fifteenth cousin' => '15<sup>e</sup> arrière-petit(e)-cousin(e)',
  ...
  'fourteenth cousin' => '14<sup>e</sup> arrière-petit(e)-cousin(e)',
  ...
  'great ×%s aunt' => 'grand-tante à la %s<sup>e</sup> génération',
  'great ×%s aunt/uncle' => 'grand-tante/oncle à la %s<sup>e</sup> génération',
  ...
  'great ×%s uncle' => 'grand-oncle à la (%s-1)<sup>e</sup> génération',
  'great ×(%s-1) grandfather’s brothergreat ×%s uncle' => 'grand-oncle à la (%s-1)<sup>e</sup> génération',
  'great ×(%s-1) grandmother’s brothergreat ×%s uncle' => 'grand-oncle à la (%s-1)<sup>e</sup> génération',
  'great ×(%s-1) grandparent’s brothergreat ×%s uncle' => 'grand-oncle au (%s-1)<sup>e</sup> degré',
  'great ×4 aunt' => 'grande-tante au 5<sup>e</sup> degré',
  'great ×4 aunt/uncle' => 'grand(e)-oncle/tante au 5<sup>e</sup> degré',
  ...
  'great-great-great-grandfather’s brothergreat ×4 uncle' => 'grand-oncle à la 5e génération',
  'great-great-great-grandmother’s brothergreat ×4 uncle' => 'grand-oncle à la 5e génération',
  'great-great-great-grandparent’s brothergreat ×4 uncle' => 'grand-oncle à la 5e génération',
  'great ×5 aunt' => 'grand-tante à la 6e génération',
  'great ×5 aunt/uncle' => 'grande-tante/grand-oncle à la 6e génération',
  ...
  'great ×4 grandfather’s brothergreat ×5 uncle' => 'grand-oncle à la 6e génération',
  'great ×4 grandmother’s brothergreat ×5 uncle' => 'grand-oncle à la 6e génération',
  'great ×4 grandparent’s brothergreat ×5 uncle' => 'grand-oncle à la 6e génération',
  'great ×6 aunt' => 'grande-tante à la 7e génération',
  'great ×6 aunt/uncle' => 'grande-tante/grand-oncle à la 7e génération',
  ...
  'great ×5 grandfather’s brothergreat ×6 uncle' => 'grand-oncle à la 6e génération',
  ...
  'great ×7 aunt' => 'grande-tante à la 8e génération',
  'great ×7 aunt/uncle' => 'grande-tante/grand-oncle à la 8e génération',
  ...
  'great ×6 grandfather’s brothergreat ×7 uncle' => 'grand-oncle à la 8e génération',
  'great ×6 grandmother’s brothergreat ×7 uncle' => 'grand-oncle à la 8e génération',
  'great ×6 grandparent’s brothergreat ×7 uncle' => 'grand-oncle à la 8e génération',
  ...
  'parent’s parent’s fathergreat-grandfather' => 'arrière-grand-père',
  'father’s father’s mothergreat-grandmother' => 'arrière-grand-mère',
  'father’s mother’s mothergreat-grandmother' => 'arrière-grand-mère',
  'father’s parent’s mothergreat-grandmother' => 'arrière-grand-mère',
  'mother’s father’s mothergreat-grandmother' => 'arrière-grand-mère',
  'mother’s mother’s mothergreat-grandmother' => 'arrière-grand-mère',
  'mother’s parent’s mothergreat-grandmother' => 'arrière-grand-mère',
  'parent’s father’s mothergreat-grandmother' => 'arrière-grand-mère',
  'parent’s mother’s mothergreat-grandmother' => 'arrière-grand-mère',
  ...
  'great-great-grandfather' => 'grand-père à la 4e génération',
  'great-great-grandmother' => 'grand-mère à la 4e génération',
  'great-great-grandparent' => 'arrière-arrière-grands-parents',
  'great-great-grandson' => 'arrière-arrière-petit-fils',
  'great-great-great-aunt' => 'grand-tante à la 4e génération',
  'great-great-great-aunt/uncle' => 'grand-tante/grand-oncle à la 4e génération',
  ...
  '(a woman’s) great-great-great-nephew/niecegreat-great-great-nephew/niece' => 'arrière-arrière-petit-neveu/petite-nièce',
  ...
  'great-great-grandfather’s brothergreat-great-great-uncle' => 'grand-oncle à la 4e génération',
  'great-great-grandmother’s brothergreat-great-great-uncle' => 'grand-oncle à la 4e génération',
  'great-great-grandparent’s brothergreat-great-great-uncle' => 'grand-oncle à la 4e génération',
  ...
  '(a man’s) brother’s great-grandchildgreat-great-nephew/niece' => 'arrière-petit-neveu/petite-nièce',
  '(a man’s) sister’s great-grandchildgreat-great-nephew/niece' => 'arrière-petit-neveu/petite-nièce',
  '(a woman’s) great-great-nephew/niecegreat-great-nephew/niece' => 'arrière-petit-neveu/petite-nièce',
  ...
  'MALEmarried' => 'marié',
  'married name' => 'nom après mariage',
  'FEMALEmarried name' => 'nom après mariage',
  'MALEmarried name' => 'nom après mariage',
  ...
  'ninth cousin' => 'cousin/cousine au neuvième degré',
  ...
  'FEMALEpartner' => 'Conjointe de fait',
  'MALEpartner' => 'Conjoint de fait',
  ...
  'show the chart' => 'montrer le graphique',
  'sibling' => 'frère/sœur',
  'sign in' => 'connexion',
  'sign out' => 'déconnexion',
  'sister' => 'sœur',
  ...
  'sort by date, newest first' => 'Trier par les plus récentes dates en premier',
  'sort by date, oldest first' => 'Trier par les plus anciennes dates en premier',
  ...
  'tenth cousin' => '10<sup>e</sup> arrière-petit(e)-cousin(e)',
  ...
  'the folder “/data” and the file “/data/config.ini.php” have access permissions that allow the webserver to read them' => 'Le dossier «&nbsp;/data&nbsp;» et le fichier «&nbsp;/data/config.ini.php&nbsp;» ont les autorisations d’accès qui permettent au serveur web de les lire',
  'themself' => 'lui-même',
  'third %s' => 'troisième %s',
  'FEMALEthird %s' => 'troisième %s',
  'MALEthird %s' => 'troisième %s',
  'third cousin' => 'arrière-petit(e)-cousin(e)',
  'FEMALEthird cousin' => 'arrière-petite-cousine',
  'MALEthird cousin' => 'arrière-petit-cousin',
  'thirteenth cousin' => '13<sup>e</sup> arrière-petit(e)-cousin(e)',
  ...
  'tls' => 'TLS',
  'to %s' => 'vers %s',
  'twelfth cousin' => '12<sup>e</sup> arrière-petit(e)-cousin(e)',
