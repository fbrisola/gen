...
return array (
  ...
  '(age %s)' => '(âge %s)',
  '(aged %s)' => '(âgé de %s)',
  'Female(aged %s)' => '(âgée de %s)',
  'Male(aged %s)' => '(âgé de %s)',
  ...
  'A list of locations.' => 'Liste des lieux partagés.',
  ...
  'A list of submitters.' => 'Une liste de fournisseurs de données.',
  ...
  'Add a fact' => 'Ajouter un événement',
  ...
  'Ancestry PID' => 'Identifiant Ancestry®',
  ...
  'Are you sure you want to delete the link to “%s”?' => 'Voulez-vous vraiment supprimer le lien vers « %s » ?',
  ...
  'Associate events with this source' => 'Événements associés à cette source',
  ...
  'Barbados' => 'Barbade',
  'Base GEDCOM tag' => 'Balise GEDCOM racine',
  ...
  'Changed by %1$s' => 'Modifié par %1$s',
  ...
  'Convert NAME:_XXX tags to GEDCOM 5.5.1' => 'Convertir les balises NAME:_XXX en GEDCOM 5.5.1',
  ...
  'Create a location' => 'Créer un nouveau lieu partagé',
  ...
  'Create a submission' => 'Créer un nouvel envoi de données',
  ...
  'Date of LDS confirmation' => 'SDJ : date de la confirmation',
  ...
  'Date of engagement' => 'Date de fiançailles',
  ...
  'Date range' => 'Période',
  'Date ranges are used to indicate that an event, such as a birth, happened on an unknown date within a possible range.' => 'Les plages de dates sont utilisées pour indiquer qu’un événement, comme une naissance, est arrivé à une date inconnue mais dans une plage possible.',
  ...
  'Event' => 'Événement',
  'Events' => 'Événements',
  'Events in countries' => 'Événements par pays',
  ...
  'Family census' => 'Recensement familial',
  ...
  'FamilySearch ID' => 'Identifiant FamilySearch',
  'Fan chart' => 'Roue',
  ...
  'GOV identifier' => 'Identifiant GOV',
  'Gabon' => 'Gabon',
  'Gambia' => 'Gambie',
  'Gender' => 'Sexe',
  ...
  'Generations of descendants' => 'Nombre de générations de descendants',
  ...
  'Hide unused locations' => 'Masquer les lieux non utilisés',
  'Hierarchical relationship' => 'Lien hiérarchique',
  ...
  'If this individual has any events other than death, burial, or cremation more recent than this number of years, they are considered to be “alive”. Children’s birth dates are considered to be such events for this purpose.' => 'Si cet individu a des événements autres que décès, inhumation ou crémation plus récents que ce nombre d’années, il est considéré comme « vivant ». Les dates de naissance des enfants sont considérées comme des événements récents pour l’individu.',
  ...
  'In some calendars, days start at midnight. In other calendars, days start at sunset. The conversion process does not take account of the time, so for any event that occurs between sunset and midnight, the conversion between these types of calendar will be one day out.' => 'Pour certains calendriers, le jour commence à minuit. Pour d’autres, le jour commence au coucher du soleil. La conversion ne tient pas compte de l’heure, donc pour un événement qui eut lieu entre le coucher du soleil et minuit, la conversion pourra être décalée d’un jour.',
  ...
  'Location' => 'Lieu partagé',
  'Locations' => 'Lieux partagés',
  'Lodger' => 'Locataire',
  ...
  'Matomo™ / Piwik™ analytics' => 'Matomo™ / Piwik™',
  ...
  'New GEDCOM tag' => 'Nouvelle balise GEDCOM',
  ...
  'No events exist for today.' => 'Aucun événement pour aujourd’hui.',
  'No events exist for tomorrow.' => 'Aucun événement pour demain.',
  'No facts exist for this family.' => 'Aucun événement pour cette famille.',
  ...
  'Other' => 'Autres',
  'Other facts to show in charts' => 'Autres événements à afficher dans les diagrammes',
  ...
  'Phonetic type' => 'Méthode de transcription phonétique',
  'Photo' => 'Photo',
  ...
  'Place of LDS confirmation' => 'SDJ : lieu de la confirmation',
  ...
  'Place of engagement' => 'Lieu des fiançailles',
  'Place of event' => 'Lieu de l’événement',
  ...
  'Priest' => 'Prêtre',
  'Primidi' => 'Primidi',
  'Print basic events when blank' => 'Imprimer les événements de base même vides',
  'Priority' => 'Priorité',
  ...
  'Proxy' => 'Représentant par procuration',
  ...
  'Rada' => 'Rada',
  'Female pedigreeRada' => 'Adoptée par le lait',
  'Male pedigreeRada' => 'Adopté par le lait',
  'PedigreeRada' => 'Adopté(e) par le lait',
  ...
  'Recent years (&lt; 100 yrs)' => 'Événements récents (- 100 ans)',
  ...
  'Show the date and time' => 'Afficher la date et l\'heure',
  'Show the date and time of update' => 'Afficher la date et l’heure de mise à jour',
  'Show the events of close relatives on the individual page' => 'Affiche les événements de la famille proche à la page individuelle',
  ...
  'Source' => 'Source',
  'Source citation' => 'Citation de source',
  ...
  'Sources' => 'Sources',
  'Sources to the events' => 'Sources des événements',
  ...
  'Subject' => 'Objet',
  'Submission' => 'Envoi de données',
  'Submitted but not yet cleared' => 'Soumis non encore autorisé',
  'Submitter' => 'Fournisseur de données',
  'Submitter name' => 'Nom du fournisseur de données',
  'Submitters' => 'Fournisseurs de données',
  'Sudan' => 'Soudan',
  'Sun' => 'Dim',
  'Sunday' => 'Dimanche',
  ...
  'The location has been created' => 'Le lieu a été créé',
  ...
  'The parameter “%s” is missing.' => 'Le paramètre « %s » est manquant.',
  ...
  'The server could not understand this request.' => 'La syntaxe de la requête est erronée.',
  ...
  'The submission has been created' => 'L\'envoi de données a été créé',
  'The submitter has been created' => 'Le fournisseur de données a été créé',
  ...
  'This could be caused by an error at %s' => 'Cela peut être dû à une erreur sur la page %s',
  ...
  'This event occurred, but the details are unknown.' => 'Cet événement s\'est produit, mais les détails ne sont pas connus.',
  ...
  'Time' => 'Heure',
  'Time of last change' => 'Heure du dernier changement',
  ...
  'Tonga' => 'Tonga',
  'Too many requests. Try again later.' => 'Nombre de requêtes maximal dépassé. Veuillez réessayer plus tard.',
  ...
  'Type' => 'Type',
  'Type of abbreviation' => 'Type d\'abréviation',
  'Type of administrative ID' => 'Type d\'identifiant administratif',
  'Type of demographic data' => 'Type de données démographiques',
  'Type of event' => 'Type d\'événement',
  'Type of fact' => 'Type de fait',
  'Type of identification number' => 'Type du numéro d\'identification',
  'Type of location' => 'Type de lieu',
  'Type of marriage' => 'Type de mariage',
  'Type of name' => 'Type de nom',
  'Type of reference number' => 'Type du numéro de référence',
  'Type of research task' => 'Type de tâche à faire',
  'URL' => 'URL',
  ...
  'shared note' => 'note partagée',
  'show' => 'Afficher',
  'show changes made in webtrees' => 'Afficher les modifications faites dans webtrees',
  'show changes recorded in the genealogy data' => 'Afficher les modifications enregistrées dans les données généalogiques',
